...
export class Jugador {
    ...
    clickCasillaTableroVisibleNotificarContrincante(tocado) {
        this.contrincanteActivoEscuchador.escuchadorEventoAtaqueContrincante(tocado);
    }
    getMatrizLogicaVisible() {
        return this.controladorTablero.getMatrizLogicaVisible();
    }
    escuchadorEventoAtaqueContrincante(tocado) {
        if (!tocado) {
